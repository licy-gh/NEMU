...
uint32_t hwaddr_read(hwaddr_t addr, size_t len)
{
	...
	{
		int l1_2nd_line = read_cache1(addr + Cache_Block_Size_L1 - offset);
		memcpy(ret, cache1[l1_1st_line].data + offset, Cache_Block_Size_L1 - offset);
		memcpy(ret + Cache_Block_Size_L1 - offset, cache1[l1_2nd_line].data, len - (Cache_Block_Size_L1 - offset));
	}
	else
	{
